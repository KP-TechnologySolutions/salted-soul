          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between text-sm">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="hidden sm:inline">Free shipping over $70</span>
                <span className="sm:hidden">Free shipping $70+</span>
              </div>
              ...
              <div className="hidden md:flex items-center space-x-2">
                ...
                <span>10% supports local ministries</span>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-2">
            <div className="flex items-center justify-center space-x-4 text-sm">
              <div className="flex items-center space-x-2 text-purple-600">
                ...
                <span className="font-medium">$12,847 raised for local ministries</span>
              </div>
